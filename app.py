...
def main():
    ...
    <div class="nav-container">
        <a href="/" target="_self" class="nav-button nav-button-selected">🔍 Search</a>
        <a href="/Visualizations" target="_self" class="nav-button nav-button-unselected">📊 Visualizations</a>
    </div>
    """, unsafe_allow_html=True)
